...
mod tests {
    ...
    fn new() {
        ...
        assert_eq!(rp.alpha, 3, "alpha");
        assert_eq!(rp.alpha_inv, 180331931428153586757283157844700080811, "alpha_inv");
        assert_eq!(rp.m, 2, "m");
        assert_eq!(rp.capacity, 1, "capacity");
        assert_eq!(rp.MDS, vec![
